...
@interface BeintooFindFriendsVC : UIViewController <UITableViewDelegate,UITableViewDataSource,UIActionSheetDelegate,BeintooUserDelegate,BImageDownloadDelegate, UITextFieldDelegate> {
