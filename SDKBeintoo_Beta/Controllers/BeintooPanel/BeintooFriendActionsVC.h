...
@class BView, BTableView, BeintooUser, BeintooPlayer, BeintooFriendsListVC, 
	BeintooFindFriendsVC, BeintooFriendRequestsVC, BeintooWebViewVC;

@interface BeintooFriendActionsVC : UIViewController <UITableViewDelegate> {
	...
	BeintooFriendRequestsVC	*friendRequestsVC;
	BeintooWebViewVC		*recommendToAFriendVC;
